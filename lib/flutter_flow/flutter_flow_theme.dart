...
class LightModeTheme extends FlutterFlowTheme {
  Color primaryColor = const Color(0xFFCFCFDA);
  ...
  Color primaryBackground = const Color(0xFFCFCFDA);
...
class DarkModeTheme extends FlutterFlowTheme {
  Color primaryColor = const Color(0x54000000);
  Color secondaryColor = const Color(0xFF252424);
  Color tertiaryColor = const Color(0xFFEE8B60);
  Color alternate = const Color(0xFFFF5963);
